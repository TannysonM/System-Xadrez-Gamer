...
public class Rook extends ChessPiece{
	...
	public boolean[][] possibleMoves() {
		...
		//Testando a existencia de uma peça e se na rota de locomação dela, não tem outra peça
		while (getBoard().positionExists(p) && !getBoard().thereIsAPiece(p)) {
			mat[p.getRow()][p.getColumn()] = true;
			p.setRow(p.getRow() - 1);
		}//Verificar se tem uma peça adversaria na rota de movimento e validando ela como true
